...
var ProfilesController = function () {
    var _classDecorators = [(0, common_1.Controller)('profiles')];
    ...
    var ProfilesController = _classThis = /** @class */ (function () {
        function ProfilesController_1(profilesService) {
            this.profilesService = (__runInitializers(this, _instanceExtraInitializers), profilesService);
        }
        ProfilesController_1.prototype.getMyProfile = function (req) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.profilesService.findOne({ userId: req.user.userId })];
                });
            });
        };
        ProfilesController_1.prototype.updateProfile = function (req, updateProfileDto) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.profilesService.update({
