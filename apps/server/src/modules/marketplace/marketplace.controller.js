...
var MarketplaceController = function () {
    var _classDecorators = [(0, common_1.Controller)('marketplace')];
    ...
    var MarketplaceController = _classThis = /** @class */ (function () {
        ...
        MarketplaceController_1.prototype.findAll = function (search) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    where = search
                        ...
                        : {};
                    return [2 /*return*/, this.marketplaceService.findAll({ where: where })];
                });
            });
        };
        MarketplaceController_1.prototype.findOne = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.marketplaceService.findOne({ id: id })];
                });
            });
        };
        MarketplaceController_1.prototype.create = function (req, createListingDto) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.marketplaceService.create(__assign(__assign({}, createListingDto), { owner: { connect: { id: req.user.userId } } }))];
                });
            });
        };
        MarketplaceController_1.prototype.update = function (req, id, updateListingDto) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    // Ensure user owns the listing (logic can be added here or in service)
                    return [2 /*return*/, this.marketplaceService.update({
                            where: { id: id },
