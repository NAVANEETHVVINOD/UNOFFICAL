        ...
        return (
            <Container>
                <div className="min-h-screen flex flex-col items-center justify-center text-center">
                    ...
                    <RetroButton onClick={() => router.push('/notes')}>GO BACK</RetroButton>
                </div>
            </Container>
        );
    }
                            ...
                            <NewspaperCard className="p-8 border-4">
                                <div className="flex flex-col md:flex-row justify-between items-start gap-4 mb-8 border-b-2 border-black pb-6">
                                    <div>
                                        ...
                                        <h1 className="font-display text-4xl md:text-5xl font-black mb-2">{note.title}</h1>
                                    ...
                                    <div className="flex gap-2">
                                        <RetroButton onClick={handleLike} variant="outline" className="flex items-center gap-2">
                                ...
                                <div className="prose font-body text-lg leading-relaxed mb-8">
                                    <h3 className="font-bold text-xl uppercase mb-4">Description</h3>
                                ...
                                <div className="bg-gray-100 border-2 border-dashed border-gray-300 p-8 text-center rounded-lg">
                                    <Doodle src="/doodles/file.svg" className="w-16 h-16 mx-auto mb-4 opacity-50" />
                                    <p className="font-mono text-gray-500">Preview not available. Please download to view.</p>
                                </div>
                            </NewspaperCard>
                        </motion.div>
                    </div>
