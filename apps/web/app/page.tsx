      ...
      <Container>
        <div className="py-8 pb-24 md:pb-8">
          ...
          <nav className="flex justify-between items-center mb-16 px-4">
            ...
            >
              <div className="w-12 h-12 bg-accent-yellow border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] flex items-center justify-center text-black font-black text-2xl font-display">
                L
              </div>
              <span className="font-display font-black text-3xl tracking-wide text-black drop-shadow-[2px_2px_0px_rgba(0,0,0,0.2)]">
                LINKER
              </span>
            </Link>
            <div className="hidden md:flex gap-2">
              ...
              <Link href="/login">
                <RetroButton variant="secondary" className="ml-2">
                  Login
                </RetroButton>
              </Link>
            </div>
