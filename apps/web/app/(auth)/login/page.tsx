      ...
      <div className="min-h-screen w-full bg-[#f0f0f0] relative overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none opacity-50">
          <div className="absolute top-10 left-10 animate-float-slow">
            <Doodle src="/doodles/colud.jpg" className="w-32 mix-blend-multiply" />
          </div>
          <div className="absolute bottom-20 right-10 animate-float-delayed">
            <Doodle src="/doodles/sun.jpg" className="w-40 mix-blend-multiply" />
          </div>
          <div className="absolute top-1/3 right-20 rotate-12">
            <Doodle src="/doodles/sparkle.svg" className="w-12 h-12" />
          </div>
        </div>
        ...
        <Container>
          <div className="min-h-screen flex flex-col items-center justify-center py-12 relative z-10">
            ...
            <div className="w-full max-w-md relative">
              ...
              <div className="absolute -right-12 -top-12 hidden md:block z-20">
                <Doodle src="/doodles/CD.jpg" className="w-24 h-24 animate-spin-slow rounded-full border-2 border-black shadow-lg" />
              </div>
              <div className="absolute -left-8 bottom-10 hidden md:block z-20">
                <Doodle src="/doodles/arrow-scribble.svg" className="w-16 h-16 transform rotate-45" />
              </div>
              ...
              <NewspaperCard className="border-4 p-8 relative bg-white shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
                ...
                <form className="space-y-6" onSubmit={handleSubmit}>
                  ...
                  <RetroButton
                    type="submit"
                    className="w-full py-4 text-xl hover:-translate-y-1 hover:shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] transition-all"
                    disabled={loading}
                  >
                ...
                <div className="mt-8">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <button className="flex items-center justify-center gap-2 border-2 border-black p-3 hover:bg-gray-50 transition-all hover:-translate-y-0.5 hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] bg-white">
