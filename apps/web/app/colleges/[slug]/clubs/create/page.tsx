...
export default function CreateClubPage({ params }: PageProps) {
  ...
  if (
    ...
    router.replace(`/colleges/${slug}/clubs`);
    return null;
  }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await api.createClub({ ...formData, collegeSlug: slug });
  ...
  return (
    <div className="min-h-screen py-12">
      <div className="max-w-2xl mx-auto">
        <NewspaperCard className="p-8 relative bg-white">
          ...
          <div className="text-center mb-8">
            <Badge className="mb-2 bg-accent-purple text-white border-black">
              NEW CLUB
            </Badge>
      ...
      <Doodle
        ...
        className="fixed bottom-10 left-10 w-32 h-32 opacity-20 rotate-12 pointer-events-none"
      />
    </div>
  );
}
