...
import { Search, Plus, Filter, ShoppingBag, User, Tag, Grid, List, Briefcase, Store } from "lucide-react";
        ...
        <Container>
          <div className="pt-24 md:pt-36 pb-24 md:pb-8 relative z-10">
            ...
            {loading ? (
              ...
              <motion.div
                className={`grid ${viewMode === "grid" || activeTab === "work" ? "md:grid-cols-2 lg:grid-cols-3" : ""} gap-6`}
