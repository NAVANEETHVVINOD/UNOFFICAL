        ...
        <PageTransition>
            <Container>
                <div className="py-8 min-h-screen">
                    ...
                    >
                        <Doodle src="/doodles/shopping-bag.svg" className="w-24 h-24 absolute -top-12 left-1/4 -z-10 opacity-20 -rotate-12" />
                        <h1 className="font-display text-5xl md:text-7xl font-black mb-4">MARKETPLACE</h1>
                                        ...
                                        <NewspaperCard className="h-full hover:-translate-y-2 hover:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] transition-all cursor-pointer group bg-white p-0 overflow-hidden flex flex-col">
                                            ...
                                            <div className="h-48 bg-gray-100 border-b-2 border-black flex items-center justify-center relative overflow-hidden">
                                                {item.imageUrl ? (
                                                    ...
                                                    <Doodle src="/doodles/camera.svg" className="w-16 h-16 opacity-20" />
                                                )}
                                            ...
                                            <div className="p-6 flex-grow flex flex-col">
                                                <h3 className="font-bold text-xl mb-2 group-hover:underline decoration-2 decoration-accent-blue line-clamp-1">{item.title}</h3>
                    ...
                    {!loading && filteredListings.length === 0 && (
                        <div className="text-center py-20">
                            ...
                            <p className="text-gray-600">The market is empty. Be the first to sell something!</p>
                            <div className="mt-6">
