        ...
        <Container>
            <div className="min-h-screen flex items-center justify-center py-8 md:py-12">
                <div className="w-full max-w-5xl relative">
                    {/* Floating Decor */}
                    <Doodle src="/doodles/sparkle.svg" className="absolute -top-12 -right-8 w-32 h-32 text-accent-yellow animate-spin-slow z-0" />
                    ...
                    <NewspaperCard className="p-0 overflow-hidden grid md:grid-cols-2 shadow-neo-lg relative z-10 bg-white">
                        ...
                        <div className="bg-accent-pink p-8 md:p-12 flex flex-col justify-between relative overflow-hidden border-b-4 md:border-b-0 md:border-r-4 border-black min-h-[300px] md:min-h-full order-first md:order-last">
                            ...
                            <div className="relative z-10">
                                <Badge className="bg-black text-white border-white rotate-[2deg] mb-6 inline-block shadow-neo-sm">NEW_RECRUIT</Badge>
                            ...
                            <div className="relative z-10 mt-8 md:mt-0 hidden md:block">
                                <div className="bg-white text-black p-4 rounded-xl border-2 border-black shadow-neo transform -rotate-2">
                                    ...
                                    <div className="mt-3 flex justify-end">
                                        <div className="px-3 py-1 bg-accent-green text-xs font-bold rounded-full border border-black">APPROVED</div>
                                    </div>
                                </div>
                            </div>

                            {/* Giant Doodle */}
                            <Doodle src="/doodles/star.svg" className="absolute -bottom-12 -left-12 w-64 h-64 text-black opacity-10 rotate-12" />
                        </div>
                        ...
                        <div className="p-8 md:p-16 bg-white relative flex flex-col justify-center order-last md:order-first">
                            ...
                            <Sticker className="absolute top-4 left-4 bg-accent-yellow text-black -rotate-6 hidden md:block">FREE</Sticker>

                            <div className="mb-8">
                                <h2 className="font-bold text-2xl mb-1">Create Account</h2>
                                <p className="text-gray-500 text-sm">Join thousands of students on Linker.</p>
                            </div>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-5">
                                <div className="space-y-2">
                                    <label className="font-bold text-xs uppercase tracking-wider text-gray-700">Full Name</label>
                                    <input
                                        type="text"
                            ...
                            <div className="mt-8 pt-8 border-t border-gray-100 text-center">
                                <p className="text-sm text-gray-600">
                                    ...
                                    <Link href="/login" className="font-black underline decoration-2 decoration-accent-pink hover:bg-accent-pink hover:text-white transition-colors px-1">
                                        Login Here
                                    </Link>
                                </p>
                            </div>
