...
export default function PostCard({ post }: { post: any }) {
    ...
    return (
        <>
            <div className="group relative bg-white border-2 border-black shadow-neo hover:shadow-neo-lg transition-all duration-300">

                {/* Torn Paper Header Mask (Optional - can be pure CSS or SVG) */}
                ...
                <div className="px-4 py-3 bg-paper border-t-2 border-black flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-1">
                        <RetroButton variant="ghost" className="p-2 hover:bg-blue-50" onClick={() => setIsCommentsOpen(true)}>
            ...
            <CommentDrawer isOpen={isCommentsOpen} onClose={() => setIsCommentsOpen(false)} postId={post.id} />
        </>
    );
}
