      ...
      <div className="container mx-auto px-6 z-10 relative">
        <div className="max-w-6xl mx-auto text-center">
          ...
          >
            ...
            <span className="font-black text-lg font-body text-gray-800">
              Where College Life Comes Alive!
            </span>
          </motion.div>
          ...
          >
            ...
            digital notebook for <span className="text-blue-600">events</span>,{" "}
          ...
          >
            ...
            >
              ...
              <CalendarDoodle
                ...
                stroke="currentColor"
              />
              <h3 className="font-black text-2xl mb-2 font-hand">Events</h3>
              <p className="text-gray-600 font-bold font-body">
                Never miss a campus happening!
              </p>
            </motion.div>
            ...
            >
              ...
              <GroupDoodle
                className="w-14 h-14 text-white mb-4"
                stroke="white"
              />
