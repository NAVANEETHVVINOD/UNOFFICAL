...
*(Reconstructed and expanded from the uploaded “Untitled document.docx”)*
...
- Suggest Event
- Edit Profile
### <a name="ai-assistant-entry-next-version"></a>**4. AI Assistant Entry** *(Next Version)*
- Floating widget
...
- **Experience & Activities** *(driven from other modules)*\
\

  - Event roles (from events\_participation table: role = organiser/speaker/volunteer/participant)
